...
const ChatPage = () => {
	...
	return (
		<section className=" mt-4 mx-3 md:mt-6 flex flex-col gap-4 items-center">
				{!loading ? (
					<div className="w-full md:w-[80%] max-lg:mt-12">
						<h1 className="py-2 w-fit text-3xl md:text-5xl lg:text-7xl font-extrabold bg-gradient-to-r from-blue-400 to-green-400 via-purple-400 bg-clip-text backdrop-blur-md text-transparent">
							Hello, <span className="truncate">{username ? username : "User"}</span>
						</h1>
					...
					<div className="max-md:p-1 p-4 w-full md:w-[85%] lg:w-[75%] bg-gray-700 overflow-y-scroll h-[calc(100vh-12rem)] rounded-lg custom-scrollbar">
